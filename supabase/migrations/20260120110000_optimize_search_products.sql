-- Migration: Optimize search_products for better mobile performance
-- Use full-text search with ranking instead of word_similarity for faster queries
-- Created at: 2026-01-20 11:00:00
...
-- rollback:
-- DROP FUNCTION IF EXISTS public.search_products(text);
-- -- Restore previous version with word_similarity
